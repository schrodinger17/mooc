    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="id[5]" label="ID" width="55" align="center"></el-table-column>
                ...
                <el-table-column prop="src" label="链接地址"></el-table-column>
...
<script>
import { fetchData } from '../../../api/resource';
export default {
    name: 'resourcetable',
    data() {
        return {
