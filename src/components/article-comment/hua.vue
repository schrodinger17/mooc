<template>
  <div id="drag" ref="drag" class="drag" :style="drag">
    <div id="drag_bg" ref="drag_bg" class="drag_bg" :style="drag_bg_style"></div>
    <div ref="drag_text" class="drag_text" :style="drag_text_style">{{ confirmWords }}</div>
    <div id="handler" ref="handler" :class="handler_class" :style="handler_style"
