  ...
  <div class="b_comment_bg">
    <div class="comment-content">
      <div class="comment-head">
        ...
        <div class="area-bg">
          <el-input id="comment_text" ref="comment_text" v-model="insert_comment.comment_text"
                    class="comment-text"
                    resize="none"
                    type="textarea"
                    :rows="2"
        ...
        <div class="submit-bg">
          ...
          >
            ...
            <div class="emoji-box" style="display: block; left: 86px; top: 209px;">
              ...
              <div class="emoji-wrap">
                <a v-for="item in emojilist" :key="item" class="emoji-list emoji-text" :data-emoji-text="item"
                   @click="add_emoji(item)"
                >{{ item }}</a>
              </div>
            </div>
            <el-button slot="reference" size="small" plain @click="emoji_focus()">
              <i
          ...
          <div class="submit_area">
            <el-popover ref="popover_comment"
                        ...
                        :content="comment_msg"
            >
              <el-button ref="comment_Button" slot="reference" v-popover:popover_comment :loading="buttom_loading" class="a"
                         type="primary" size="medium" style="position:relative;maring-right:0px;padding-left:45px;padding-right:45px;"
